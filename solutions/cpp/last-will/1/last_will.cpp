...
namespace estate_executor {
    ...
    // 1. Combine the bank numbers (this one is already correct!)
    ...
    // 2. Multiply the sum of red fragments by the sum of blue fragments
    int assemble_code() {
        int total_red = zhang::red::code_fragment() + 
                        khan::red::code_fragment() + 
                        garcia::red::code_fragment();
                        
        int total_blue = zhang::blue::code_fragment() + 
